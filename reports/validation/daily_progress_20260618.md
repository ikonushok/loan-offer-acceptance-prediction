...
## КЛЮЧЕВОЙ ИНСАЙТ
**test-weighted AUC champion = 0.7755 ≈ ориентир 0.775.** На тест-подобных данных ранжировка champion уже хороша. Разрыв до публичного 0.76054 — остаточная сложность периода Q4 2025, НЕ закрываемая пересборкой существующих данных. Доп. данных не будет (подтверждено). Все offline-рычаги исчерпаны.
